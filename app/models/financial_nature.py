...
class FinancialNature(db.Model):
    ...
    # Se True, não considera no abatimento do residual/distrato do motoboy (pagamentos quitados não reduzem o residual).
    does_not_consider_residual = db.Column(db.Boolean, nullable=False, default=False)
